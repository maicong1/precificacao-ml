...
# Configurações de página com favicon oficial da ARJ
st.set_page_config(
...
# Custom CSS para mobile responsivo e fullscreen
st.markdown(
    '''
    <style>
    html, body, [class*="css"]  {
...
st.caption("🔄 Desenvolvido pela ARJ Representações - Otimizado para dispositivos móveis")
